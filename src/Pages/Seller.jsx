...
const SellerMode = ({ userName }) => {
  ...
  const [shortDescCharCount, setShortDescCharCount] = useState(25);
  ...
  const handleShortDescriptionChange = (event) => {
    ...
    if (value.length <= 25) {
      ...
      setShortDescCharCount(25 - value.length);
    }
  };
  ...
  const handleFormSubmit = async (event) => {
    ...
    if (shortDescription.length > 25) {
      setErrorMessage('Short description exceeds the maximum allowed length of 25 characters.');
      return;
    }
    ...
    <div className='sellermode'>
      ...
      <form className='sellermode-form' onSubmit={handleFormSubmit}>
        <div className='sellermode-row'>
          <label htmlFor='productImage'>Product Image <span className="required">*</span></label>
          <input type='file' id='productImage' onChange={handleImageUpload} required />
